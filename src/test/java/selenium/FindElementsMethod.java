...
public class FindElementsMethod {
		...
		public static void main(String[] args) 
	{
		...
		List<WebElement> l3=driver.findElements(By.tagName("//*"));
		System.out.println("Links count is "+l3.size());
		 
		//Count of select tag dropdowns in page
		int count1=0;
		int count2=0;
		List<WebElement> l4=driver.findElements(By.tagName("Select"));
		System.out.println("Total number of selecttag dropdowns count "+l4.size());
		...
		//way1
		int count=0;
		List<WebElement> l6=driver.findElements(By.xpath("input"));
